    ...
    <html lang="en">
      <body style={{ background: '#F7F3EE', minHeight: '100vh' }}>
        <nav style={{
          ...
          borderBottom: '1px solid rgba(43,42,40,0.07)',
        }}>
          <div style={{
            ...
            <a href="/" style={{
              ...
              fontSize: 20, letterSpacing: '0.13em', color: '#2B2A28', textDecoration: 'none',
            }}>archive</a>
            <span style={{
              fontFamily: "'Courier New', monospace",
              fontSize: 10, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#8A6F5A',
            }}>Print · Preserve · Cherish</span>
            <a href="/orders" style={{
              fontFamily: "'Courier New', monospace",
              fontSize: 10, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#8A6F5A', textDecoration: 'none',
            }}>track order</a>
          </div>
        </nav>
        <main>{children}</main>
        <footer style={{
          ...
          <p style={{ fontFamily: "'Courier New', monospace", fontSize: 10, color: '#8A6F5A', letterSpacing: '0.06em', textTransform: 'uppercase' }}>
            ...
            <a href="mailto:orders@archiveyours.com" style={{ color: '#8A6F5A' }}>orders@archiveyours.com</a>
          </p>
        </footer>
      </body>
    </html>
