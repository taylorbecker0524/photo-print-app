...
export const metadata: Metadata = {
  title: 'archive',
  description: 'Premium photo prints with date, time and location stamps.',
}
    ...
    <html lang="en">
      ...
      <body style={{ background: '#F7F3EE', minHeight: '100vh', margin: 0, padding: 0, overflowX: 'hidden' }}>
        ...
        <footer style={{
          ...
          <p style={{ fontFamily: 'Georgia, serif', fontSize: 16, color: '#8A6F5A', fontStyle: 'italic', marginBottom: 6 }}>
